    ...
    >
      ...
      <div className="flex justify-between items-center mb-8">
        ...
        <button
          ...
          className="px-6 py-2 rounded-xl font-bold text-gray-900 transition-all duration-300 hover:scale-105 active:scale-95"
          style={{
      ...
      {/* Shop Content */}
      <div className="flex-grow flex items-start pt-20 justify-center pr-[26rem]">
